...
def classify(file, ch):
    ...
    if ch == 0:
        ...
        if result < 0.02:
            # return 'Benign(safe)'
            result = 'Benign(safe)_ The App You have Uploaded Scanned and Its Safe to Use'
        else:
            # return 'Malware'
            result = 'Cyber Fraud App - The App You have Uploaded Scanned and Its Unsafe to Use. Take care your Data'
    if ch == 1:
